...
class UrlTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    {
        // Does nothing here
        $this->assertEquals('http://e.com/color?a=1', (string) Url::factory('http://e.com/color?a=1')->addPath(false));
        $this->assertEquals('http://e.com/color?a=1', (string) Url::factory('http://e.com/color?a=1')->addPath(''));
        $this->assertEquals('http://e.com/color?a=1', (string) Url::factory('http://e.com/color?a=1')->addPath('/'));

        $this->assertEquals('http://e.com/color/relative?a=1', (string) Url::factory('http://e.com/color?a=1')->addPath('relative'));
        $this->assertEquals('http://e.com/color/relative?a=1', (string) Url::factory('http://e.com/color?a=1')->addPath('/relative'));
    }
