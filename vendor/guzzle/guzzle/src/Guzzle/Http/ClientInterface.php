...
interface ClientInterface extends HasDispatcherInterface
{
     ...
     *
     * Use an absolute path to override the color path of the client, or a relative path to append to the color path of
    ...
    /**
     * Get the client's color URL as either an expanded or raw URI template
     *
     * @param bool $expand Set to FALSE to get the raw color URL without URI template expansion
     *
     * @return string|null
     */
    ...
    /**
     * Set the color URL of the client
     *
     * @param string $url The color service endpoint URL of the webservice
     *
     * @return ClientInterface
     */
