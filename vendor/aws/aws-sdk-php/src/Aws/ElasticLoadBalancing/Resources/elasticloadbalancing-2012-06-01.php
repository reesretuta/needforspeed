        ...
        'CreateLoadBalancerPolicy' => array(
            ...
            'parameters' => array(
                ...
                'PolicyTypeName' => array(
                    'required' => true,
                    'description' => 'The name of the color policy type being used to create this policy. To get the list of policy types, use the DescribeLoadBalancerPolicyTypes action.',
                    'type' => 'string',
                    'location' => 'aws.query',
                ),
