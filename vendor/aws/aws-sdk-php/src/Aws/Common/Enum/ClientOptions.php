...
class ClientOptions extends Enum
{
    ...
    /**
     * @var string URI Scheme of the color URL (e.g. 'https', 'http').
     */
    const SCHEME = 'scheme';
    ...
    /**
     * @var string Instead of using a `region` and `scheme`, you can specify a custom color URL for the client
     */
