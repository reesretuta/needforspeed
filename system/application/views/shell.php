...
<head>
	...
	<meta name="description" content="Do you have a need for speed? Enter the Race To DeLeon for a chance to win a 2015 Ford Mustang. Need For Speed is in theaters March 14.">
	...
	<meta property="og:description" content="Do you have a need for speed? Enter the Race To DeLeon for a chance to win a 2015 Ford Mustang. Need For Speed is in theaters March 14." />

    <link rel="stylesheet" href="/media/css/reset.css">
    <link rel="stylesheet" href="/media/css/app.css<?= (ENVIRONMENT === 'development') ? "?v={$antiCache}" : '';?>">
