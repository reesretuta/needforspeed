...
// 	$db['default']['username'] = 'b2bda428647173';
// 	$db['default']['password'] = 'a5a96527';
// 	$db['default']['database'] = 'nfs-mysql-development';
// }else{
// 	$db['default']['hostname'] = 'us-cdbr-azure-west-b.cleardb.com';
// 	$db['default']['username'] = 'bd1df8fd21927e';
// 	$db['default']['password'] = 'b704edca';
// 	$db['default']['database'] = 'nfs-mysql-production';
// }
...
$db['default']['cachedir'] = 'system/application/cache/';
